...
## temp.cus <- efp(Vt ~ ti, h = 0.15, type = "OLS-MOSUM")
## temp.cus <- efp(nhtemp ~ 1, h = 0.15, type = "OLS-MOSUM")
## temp.cus <- efp(nhtemp ~ ti, h = 0.15, type = "OLS-MOSUM")
## temp.cus$process
## sctest(temp.cus)
